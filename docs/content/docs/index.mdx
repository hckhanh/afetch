---
title: Introduction
description: Learn about afetch – a type-safe API client with schema validation using Standard Schema
---
...
3. **Clean API**:
   ...
   - Integrated with fast-url for clean URL construction
...
<Cards>
  ...
  <Card title="Minimal" icon={<Feather />}>
    Small bundle size with minimal dependencies - only fast-url and Standard
    Schema spec
  </Card>
  <Card title="URL Building" icon={<Code />}>
    Integrated with fast-url for clean, safe URL construction with path and
    query parameters
  </Card>
